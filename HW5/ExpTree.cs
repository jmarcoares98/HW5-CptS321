...
namespace Cpts321
{
    public class ExpTree
    {
        ...
        //    foreach (char x in expr)
        //    {
        //        if(!op.Contains<char>(x))
        //        {
        //            xString = x.ToString(); // so it can be pushed into the stack
        //            stack.Push(xString);
        //        }
        ...
        //        else if(x == ')')
        //        {
        //            while(stack.Peek() != "(" && stack.Count != 0) // removing parenthese from right to left
        //            {
        //                stack.Push(stack.Pop());
        //            }
        //        }

        //        else if(op.Contains<char>(x) == true && (stack.Count() == 0 || stack.Peek() == "("))
        //        {
        //            xString = x.ToString();
        //            stack.Push(xString);
        //        }
